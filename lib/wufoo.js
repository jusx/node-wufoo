...
Wufoo.prototype.getForms = function() { // (params, fn)
   var args = Array.prototype.slice.call(arguments, 0),
      ...
      fn = args.shift();
   this._getObjects("forms", params, fn, "Forms", Form);
}
...
Wufoo.prototype.getForm = function() { // (id, params, fn)
   var args = Array.prototype.slice.call(arguments, 0),
      ...
      params = (args.length==2 ? args.shift() : {}),
      fn = args.shift();
   this._getObjects("forms/" + id, params, fn, "Forms", Form, true);
}
...
Wufoo.prototype.getFormEntries = function() { // (id, params, fn)
   var args = Array.prototype.slice.call(arguments, 0),
      ...
      params = (args.length==2 ? args.shift() : {}),
      fn = args.shift();
   this._getObjects("forms/" + id + "/entries", params, fn, "Entries", GenericEntity);
}
...
Wufoo.prototype.getReports = function() { // (params, fn)
   var args = Array.prototype.slice.call(arguments, 0),
      params = (args.length==2 ? args.shift() : {}),
      fn = args.shift();
   this._getObjects("reports", params, fn, "Reports", Report);
}
...
Wufoo.prototype.getReport = function() { // (id, params, fn)
   var args = Array.prototype.slice.call(arguments, 0),
      ...
      params = (args.length==2 ? args.shift() : {}),
      fn = args.shift();
   this._getObjects("reports/" + id, params, fn, "Reports", Report, true);
}
...
Wufoo.prototype.getReportEntries = function() { // (id, params, fn)
   var args = Array.prototype.slice.call(arguments, 0),
      ...
      params = (args.length==2 ? args.shift() : {}),
      fn = args.shift();
   this._getObjects("reports/" + id + "/entries", params, fn, "Entries", GenericEntity);
}
...
Wufoo.prototype.getFields = function() { // (id, params, fn)
   var args = Array.prototype.slice.call(arguments, 0),
      ...
      params = (args.length==2 ? args.shift() : {}),
      fn = args.shift();
   this._getObjects("forms/" + id + "/fields", params, fn, "Fields", GenericEntity);
}
...
Wufoo.prototype.getWidgets = function() { // (id, params, fn)
   var args = Array.prototype.slice.call(arguments, 0),
      ...
      params = (args.length==2 ? args.shift() : {}),
      fn = args.shift();
   this._getObjects("reports/" + id + "/widgets", params, fn, "Widgets", GenericEntity);
}
...
Wufoo.prototype.getComments = function() { // (id, params, fn)
   var args = Array.prototype.slice.call(arguments, 0),
      ...
      params = (args.length==2 ? args.shift() : {}),
      fn = args.shift();
   this._getObjects("forms/" + id + "/comments", params, fn, "Comments", GenericEntity);
}
...
Wufoo.prototype.getCommentCount = function() { // (id, params, fn)
   var args = Array.prototype.slice.call(arguments, 0),
      ...
      params = (args.length==2 ? args.shift() : {}),
      fn = args.shift();
   this._getMethod("forms/" + id + "/comments/count", params, function(err, json) {
